      ...
      <View style={[styles.container, { backgroundColor: bgColor }]}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.authPrompt, { backgroundColor: cardColor }]}>
            ...
            />
            <Text style={[styles.authTitle, { color: textColor }]}>Sign in to continue</Text>
    ...
    <View style={[styles.container, { backgroundColor: bgColor }]}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.tagsRow}>
                  {user.diaspora_segment?.map((segment, index) => (
                    <View key={index} style={[styles.tag, { backgroundColor: colors.highlight }]}>
                      <Text style={[styles.tagText, { color: colors.secondary }]}>{segment}</Text>
                    </View>
                  ))}
                </View>
              </View>
              ...
              <View style={styles.preferenceSection}>
                ...
                <View style={styles.tagsRow}>
                  {user.favorite_cuisines?.map((cuisine, index) => (
                    <View key={index} style={[styles.tag, { backgroundColor: colors.highlight }]}>
                      <Text style={[styles.tagText, { color: colors.secondary }]}>{cuisine}</Text>
                    </View>
                  ))}
                </View>
              </View>
          ...
          >
            <View style={styles.menuItemLeft}>
              <IconSymbol
                ...
                color={colors.primary}
              />
              <Text style={[styles.menuItemText, { color: textColor }]}>Saved/Favorite Spots</Text>
            </View>
            <IconSymbol
              ios_icon_name="chevron.right"
              android_material_icon_name="chevron-right"
          ...
          >
            <View style={styles.menuItemLeft}>
              <IconSymbol
                ...
                color={colors.primary}
              />
              <Text style={[styles.menuItemText, { color: textColor }]}>Manage Addresses</Text>
            </View>
            <IconSymbol
              ios_icon_name="chevron.right"
              android_material_icon_name="chevron-right"
        ...
        <View style={styles.appInfo}>
          ...
          <Text style={[styles.appInfoText, { color: textSecondaryColor }]}>Version 1.0.0</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  preferencesCard: { padding: 16, borderRadius: 12, marginBottom: 16, elevation: 2 },
  preferenceSection: { marginBottom: 12 },
  preferenceLabel: { fontSize: 12, fontWeight: '600', marginBottom: 8, textTransform: 'uppercase' },
  ...
  authTitle: { fontSize: 20, fontWeight: '700', marginTop: 16, marginBottom: 8 },
  authText: { fontSize: 14, textAlign: 'center', marginBottom: 20, lineHeight: 20 },
  authButton: {
  ...
  authButtonText: { color: '#1A1000', fontSize: 16, fontWeight: '700' },
  ...
  appInfo: { alignItems: 'center', gap: 4, marginBottom: 24 },
